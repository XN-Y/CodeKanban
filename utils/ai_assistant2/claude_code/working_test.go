...
// TODO: Claude Code's current UI behavior is unclear here.
// The detector now treats "Hint:" as a structured helper line and requires the
// working line to match the current ellipsis-based pattern, but we have not yet
// confirmed whether no-ellipsis "Processing request" frames should still count
// as working. Re-enable after verifying actual CLI output.
//
