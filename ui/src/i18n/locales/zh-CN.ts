export default {
  ...
  terminal: {
    ...
    confirmCloseCompleteTask: '是否将关联任务设置为完成',
    completeLinkedTaskFailed: '更新关联任务状态失败',
  ...
  webSession: {
    ...
    contextUsageRemainingEstimate: '估算剩余：{count} tokens',
    contextUsageEstimatedUsed: '估算已用：{count} tokens',
    ...
    contextUsageModeCumulativeTotal: '累计 usage total（尚未观测到上下文压缩）',
    contextUsageEstimatedBreakdown: '估算明细：input {input} / cached {cached} / output {output}',
    contextUsageTotalUsed: '累计总消耗：{count} tokens',
    contextUsageTotalBreakdown: '累计明细：input {input} / cached {cached} / output {output}',
    contextUsageNoteSinceCompaction:
      '注意：百分比按最近一次上下文压缩后的净新增 token 相对压缩线估算，不是当前上下文占用真值。',
    contextUsageNoteCumulativeTotal:
      '注意：尚未观测到上下文压缩，当前按累计 usage total 相对压缩线估算，不是当前上下文占用真值。',
