export default {
  ...
  webSession: {
    ...
    archiveAction: '归档',
    syncFromTerminal: '从终端同步',
    syncLoading: '正在从 Codex 线程同步会话历史...',
    syncSuccess: '已从 Codex 线程同步',
    syncFailed: '同步会话失败',
    ...
    contextUsageUsed: '已用：{count} tokens',
    contextUsageSource: '来源：{source}',
    contextUsageSourceConfig: 'Codex 本地配置',
    contextUsageSourceDefault: '默认值 400000',
    contextUsageBreakdown: '明细：input {input} / cached {cached} / output {output}',
    contextUsageNote:
      '注意：角标百分比按累计 usage total 相对压缩线估算；当前累计占比约为 {percent}%，不是当前上下文占用真值。',
